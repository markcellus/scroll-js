...
Scroll.prototype = {
     ...
     */
    toElement: function toElement(el, options) {
     ...
     * @memberOf Scroll
     */
    _scroll: function _scroll(el, from, to, prop, startTime, duration, easeFunc, callback) {
     ...
     * @private
     */
    _moveElement: function _moveElement(prop, value) {
     ...
     * @memberOf Scroll
     */
    _getEasing: function _getEasing(easing) {
...
},{"./utils/request-anim-polyfill":12,"promise":1}],12:[function(require,module,exports){
'use strict';
