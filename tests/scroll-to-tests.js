...
import {scrollTo, scrollIntoView} from '../src/scroll';
...
describe('Scroll', function () {
    ...
    it('should update the scrolled element\'s scrollTop property to the same coordinate specified in the second parameter supplied to scroll.to()', async function() {
